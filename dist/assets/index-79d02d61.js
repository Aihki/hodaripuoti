(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&r(s)}).observe(document,{childList:!0,subtree:!0});function o(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(n){if(n.ep)return;n.ep=!0;const a=o(n);fetch(n.href,a)}})();const l="https://hodaripuoti.northeurope.cloudapp.azure.com/api",pt=e=>{let t=`
    <div class="admin-container">
        ...
        `;return e.forEach(o=>{const{user_id:r,username:n,email:a,role:s,points:i}=o;t+=`
              ...
              `}),t+="</table></div>",t},mt=e=>{const t=document.querySelector(".user-management-table-container");t&&(t.innerHTML="");let o=`
            <table>
            <tr class="sticky-row">
                <th>ID</th>
                <th>Käyttäjänimi</th>
  ...
  `,g="";return t.map(f=>{g+=`
    ...
    `}),d+=g+"</div></div>",d},kt=()=>{Lt()},St=()=>{const e=document.querySelectorAll(".user-manage-nav-btn");e.length<=0||e.forEach(t=>{t.addEventListener("click",async()=>{document.querySelectorAll(".user-manage-active").forEach(a=>{a.classList.contains("user-manage-active")&&a.classList.remove("user-manage-active")}),t.classList.add("user-manage-active");let r="";switch(t.id){case"userManageAllWorkersBtn":r=l+"/user/workers";break;case"userManageSAdminBtn":r=l+"/user/role/2";break;case"userManageCounterBtn":r=l+"/user/role/1";break;case"userManageAllBtn":r=l+"/user";break}if(r===null)return;const n=await m(r);n?It(n):At("No users found")})})},wt=e=>{const t=document.querySelectorAll(".order-info-button");t.length<=0||t.forEach(o=>{o.addEventListener("click",async()=>{let r="";if(o.classList.contains("order-info-btn-orders")?r=l+"/order":o.classList.contains("order-info-btn-in-progress")?r=l+"/order/getFilteredOrders/1":o.classList.contains("order-info-btn-completed")?r=l+"/order/getFilteredOrders/2":o.classList.contains("order-info-btn-recieved")?r=l+"/order/getFilteredOrders/0":o.classList.contains("order-info-btn-picked-up")?r=l+"/order/getFilteredOrders/3":r=null,r!==null){const n=await m(r);S(e,n)}})})},Lt=()=>{document.querySelectorAll("#profileButton").forEach(t=>{t.addEventListener("click",async()=>{const o=document.querySelector("dialog"),r=ot();if(o&&r!==null){const n=await I(r),a=await m(l+"/order/getMyOrders/"+n.user_id),s=X(n,a);o.innerHTML="",o.insertAdjacentHTML("beforeend",s),B(),G(),tt(),Q(),Y(),et(),o.showModal();return}E(!0)})})},B=()=>{const e=document.querySelector("dialog");if(!e)return;document.querySelectorAll("#dialogCloseButton").forEach(o=>{o.addEventListener("click",()=>{e.close()})})},Y=()=>{const e=document.querySelector("#backButton");e&&e.addEventListener("click",()=>{const t=document.querySelector(".rotating-card");t!=null&&t.classList.contains("show-back")&&(t==null||t.classList.remove("show-back"))})},Q=()=>{const e=document.querySelectorAll(".profile-order-tr");!e||e.length<1||e.forEach(t=>{t.addEventListener("click",async()=>{const o=t.getAttribute("data-order-id"),r=document.querySelector(".rotating-card"),n=await m(l+"/order/orderHotdogs/"+o),a=yt(n),s=document.querySelector(".back-main-content");s&&(s.innerHTML="",s.insertAdjacentHTML("beforeend",a),(r==null?void 0:r.classList.contains("show-back"))===!1&&r.classList.add("show-back"))})})},G=()=>{const e=document.querySelectorAll("#logOutButton"),t=document.querySelector("#adminSection");e.forEach(o=>{o.addEventListener("click",()=>{localStorage.removeItem("token"),E(!0),t&&(t.innerHTML="")})})},N=()=>{const e=document.querySelector("#changeFormToLoginBtn"),t=document.querySelector("#changeFormToRegisterBtn");e==null||e.addEventListener("click",()=>{E(!0)}),t==null||t.addEventListener("click",()=>{E(!1)});const o=document.querySelector("dialog");if(!o)return;document.querySelectorAll("#dialogCloseButton").forEach(n=>{n.addEventListener("click",()=>{o.close()})})},Et=()=>{const e=document.querySelector(".user-management-table-container");e==null||e.addEventListener("submit",async t=>{if(t.preventDefault(),t.target&&t.target.tagName==="FORM"){const o=t.target,r=o.id,n=parseInt(r.split("_")[1],10),a=o.querySelector("input"),s=parseInt(a.value,10);if(isNaN(s)||s<0||s>2)return alert("Invalid role");try{const u={method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({user_id:n,role:s})};await m(l+"/user/updateRole",u)}catch{return}}})},R=async e=>{var o;const t=(o=e.currentTarget)==null?void 0:o.getAttribute("data-order-id");if(t!=null){const r=document.querySelector("dialog");if(!r)return;const n=await m(l+"/order/orderHotdogs/"+t),a=await m(l+"/order/hotdogsAndToppings/"+t);if(n.message||a.message)return;const s=bt(n,a);r.innerHTML="",r.insertAdjacentHTML("beforeend",s),r.showModal(),B()}},U=(e,t)=>{var i,u;const o=(i=t.currentTarget)==null?void 0:i.getAttribute("data-order-id"),r=o?parseInt(o,10):null,n=(u=t.currentTarget)==null?void 0:u.getAttribute("data-order-status"),a=n?parseInt(n,10):null,s=document.querySelector("dialog");if(s&&r!=null&&a!==null&&a!==void 0){let p="";switch(a){case 0:p=A(`Oletko varma haluavasi ottaa tilauksen <strong class="text-in-progress">${r} vastaan</strong>?`);break;case 1:p=A(`Oletko varma haluavasi merkata tilauksen <strong class="text-ready">${r} valmiiksi</strong>?`);break;case 2:p=A(`Oletko varma haluavasi merkata tilauksen <strong class="text-picked-up">${r} noudetuksi</strong>?`);break}s.innerHTML="",s.insertAdjacentHTML("beforeend",p);const c=document.querySelector("#confirmYesBtn");if(!c)return;c.addEventListener("click",async()=>{const d={status:a+1,order_id:r},g={method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(d)};if(await m(l+"/order/changeOrderStatus",g),a===0){const f=await m(l+"/order/getFilteredOrders/1");S(e,f)}else if(a===1){const f=await m(l+"/order/getFilteredOrders/2");S(e,f)}else if(a===2){const f=await m(l+"/order/getFilteredOrders/3");S(e,f)}else S(e);s.close()}),s.showModal()}},tt=()=>{const e=document.querySelector("#updateForm");e==null||e.addEventListener("submit",t=>{t.preventDefault(),Ct()})},et=()=>{const e=document.getElementById("checkbox");e&&e.addEventListener("change",()=>{document.body.classList.toggle("dark")})};kt();const m=async(e,t={})=>{const o=await fetch(e,t);if(!o.ok)throw new Error(`Error ${o.status} occured`);try{return await o.json()}catch(r){throw new Error(`Error parsing JSON: ${r.message}`)}},ot=()=>{const e=localStorage.getItem("token");return e||null},rt=async()=>{try{const e=ot();if(e!==null){const o=(await I(e)).role;if(o>0)S(o);else if(o===0){const r=document.querySelector("#adminSection");r&&(r.style.display="none")}}else{const t=document.querySelector("#adminSection");t&&(t.style.display="none")}}catch(e){console.error("Error:",e)}},I=async e=>{const t={headers:{Authorization:"Bearer "+e}};return await m(l+"/auth/me",t)},S=async(e,t)=>{const o=document.querySelector("#adminSection");if(!o)return;let r;t?r=t:r=await m(l+"/order");const n=gt(r);if(o.innerHTML="",o.insertAdjacentHTML("beforeend",n),wt(e),Tt(),e===2){const a=await m(l+"/user"),s=pt(a);o.insertAdjacentHTML("beforeend",s),St(),Et()}document.querySelectorAll(".viewActionBtn").forEach(a=>{a.removeEventListener("click",R)}),document.querySelectorAll(".checkActionBtn").forEach(a=>{a.removeEventListener("click",s=>U(e,s))}),document.querySelectorAll(".viewActionBtn").forEach(a=>{a.addEventListener("click",R)}),document.querySelectorAll(".checkActionBtn").forEach(a=>{a.addEventListener("click",s=>U(e,s))}),o.style.display="block"},Tt=async()=>{var s,i,u,p,c;const e=await m(l+"/order/ordersCounts");if(e.length<1)return;const t=(s=document.querySelector(".order-info-btn-orders"))==null?void 0:s.querySelector(".order-amount"),o=(i=document.querySelector(".order-info-btn-recieved"))==null?void 0:i.querySelector(".order-amount"),r=(u=document.querySelector(".order-info-btn-completed"))==null?void 0:u.querySelector(".order-amount"),n=(p=document.querySelector(".order-info-btn-in-progress"))==null?void 0:p.querySelector(".order-amount"),a=(c=document.querySelector(".order-info-btn-picked-up"))==null?void 0:c.querySelector(".order-amount");!r||!n||!t||!o||!a||(r.innerHTML=e[0].completedCount,n.innerHTML=e[0].inProgressCount,t.innerHTML=e[0].totalOrders,o.innerHTML=e[0].recievedCount,a.innerHTML=e[0].pickedUpCount)},E=e=>{const t=document.querySelector("dialog");if(t)if(e===!0){const o=ft();t.innerHTML="",t.insertAdjacentHTML("beforeend",o);const r=document.querySelector("#authForm");r==null||r.addEventListener("submit",n=>{n.preventDefault(),Mt()}),N(),t==null||t.showModal()}else{const o=ht();t.innerHTML="",t.insertAdjacentHTML("beforeend",o);const r=document.querySelector("#authForm");r==null||r.addEventListener("submit",n=>{n.preventDefault(),qt()}),N()}},qt=async()=>{const e=document.querySelector("#usernameInput").value,t=document.querySelector("#emailInput").value,o=document.querySelector("#passwordInput").value,r={username:e,password:o,email:t};if(!nt(t,o,e)){alert("Invalid input fields");return}const n={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)};await m(l+"/user",n),E(!0)},Mt=async()=>{var a;const e=document.querySelector("#emailInput").value,t=document.querySelector("#passwordInput").value,o={email:e,password:t};if(!nt(e,t,null)){alert("Invalid input fields");return}const r={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(o)},n=await m(l+"/auth/login",r);localStorage.setItem("token",n.token),(a=document.querySelector("dialog"))==null||a.close(),rt()},nt=(e,t,o)=>!(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)||t.length<8||o!==null&&o.length<3&&o.length>40),It=e=>{const t=document.querySelector(".user-management-table-container");if(!t)return;const o=mt(e);t.innerHTML="",t.insertAdjacentHTML("beforeend",o)},At=e=>{const t=document.querySelector("dialog");if(!t)return;const o=vt(e);t.innerHTML="",t.insertAdjacentHTML("beforeend",o)},_t=async(e,t)=>{const o=localStorage.getItem("token");if(!o)throw new Error("Token not found");const n=(await I(o)).user_id,a={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({user_id:n,total_price:t})};let s;try{const i=await m(l+"/order",a);if(!i||!i.order_id)throw new Error("Failed to create order");s=i.order_id}catch(i){return console.error("Error creating order:",i.message),{error:"Failed to create order"}}e.forEach(async i=>{let u;const p=i.ordersHotdogsAmount;if(i.hotdog_id===null){const d=i.base_price;if(!d)throw new Error("hotdog.base_price is undefined");const g={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({hotdog_name:"Custom",base_price:d})};try{const f=await m(l+"/hotdog",g);if(!f||!f.hotdog_id)throw new Error("Failed to create hotdog");u=f.hotdog_id}catch(f){return console.error("Error creating hotdog:",f.message),{error:"Failed to create hotdog"}}}else u=i.hotdog_id;const c={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({order_id:s,hotdog_id:u,amount:p})};try{if(!await m(l+"/order/orderHotdogs",c))throw new Error("Failed to create orderHotdogs");i.hotdog_id!==null&&s&&K(s)}catch(d){return console.error("Error creating orderHotdogs:",d.message),{error:"Failed to create orderHotdogs"}}if(i.hotdog_id===null){const d={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({hotdog_id:u,topping_ids:i.toppings})};try{if(!await m(l+"/hotdog/hotdogToppings",d))throw new Error("Failed to create hotdogToppings");s&&K(s)}catch(g){return console.error("Error creating hotdogToppings:",g.message),{error:"Failed to create hotdogToppings"}}}})},K=async e=>{let t=0;try{const o=await m(l+"/order/orderTotalPrice/"+e);if(!o)throw new Error("Failed to get order");o.forEach(n=>{n.hotdog_name==="Custom"?t+=parseFloat(n.total_topping_price):t+=parseFloat(n.hotdog_base_price)});const r={method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({total_price:t,order_id:e})};try{if(!await m(l+"/order/orderTotalPrice",r))throw new Error("Failed to PUT ordersTotalPrice")}catch(n){return console.error("Error creating ordersTotalPrice:",n.message),{error:"Failed to create ordersTotalPrice"}}}catch(o){return console.error("Error creating order:",o.message),{error:"Failed to create order"}}},Ct=async()=>{const e=document.querySelector("#usernameInput").value,t=document.querySelector("#passwordInput").value,o=document.querySelector("dialog"),r=localStorage.getItem("token");if(!r||!o)return;const n={username:e,password:t},a={method:"PUT",headers:{"Content-Type":"application/json",Authorization:"Bearer "+r},body:JSON.stringify(n)},s=await I(r);await m(l+"/user/"+s.user_id,a);const i=await m(l+"/order/getMyOrders/"+s.user_id),u=X(s,i);o.innerHTML="",o.insertAdjacentHTML("beforeend",u),B(),G(),tt(),Q(),Y(),et()};rt();const at=async(e,t={})=>{const o=await fetch(e,t);if(!o.ok)throw new Error(`Error ${o.status} occured`);return await o.json()};let v=[];const Ht=async()=>{try{const e=await at(l+"/ingridients"),t={};e.forEach(o=>{t[o.topping_type]||(t[o.topping_type]=[]),t[o.topping_type].push(o)}),Object.keys(t).forEach(o=>{const r=document.querySelector(`.${o}-container`);if(r){const n=document.createElement("h3");n.textContent=`Valitse ${o}`,r.appendChild(n),t[o].forEach(s=>{const i=`
        ...
        `;t.insertAdjacentHTML("beforeend",s)})}catch(e){console.error("Error fetching products:",e)}},q=document.querySelector(".burgermenu"),_=document.querySelector(".nav-menu");let h=[],k=[];q&&_&&(q.addEventListener("click",()=>{q.classList.toggle("active"),_.classList.toggle("active")}),document.querySelectorAll(".nav-link").forEach(e=>e.addEventListener("click",()=>{q.classList.remove("active"),_.classList.remove("active")})));const V=document.getElementById("checkbox");V&&V.addEventListener("change",()=>{document.body.classList.toggle("dark")});const Bt=e=>{const t=e.getBoundingClientRect(),o=window.innerHeight||document.documentElement.clientHeight;return t.top<=o&&t.bottom>=0},st=()=>{document.querySelectorAll("#menu .menu-item-container").forEach(t=>{Bt(t)&&t.classList.add("reveal")})};window.addEventListener("scroll",st);window.addEventListener("load",st);let y=0;const M=document.querySelectorAll(".custom-container"),C=document.querySelector(".prev"),H=document.querySelector(".next");function $(e){M.forEach(t=>{t.style.display="none"}),M[e].style.display=""}$(y);C==null||C.addEventListener("click",()=>{y--,y<0&&(y=M.length-1),$(y)});H==null||H.addEventListener("click",()=>{y++,y>=M.length&&(y=0),$(y)});xt();Ht();const J=document.querySelector("#cart-icon"),w=document.querySelector(".cart"),z=document.querySelector("#cart-close");J&&w&&z&&(J.addEventListener("click",()=>{w&&w.classList.add("active")}),z.addEventListener("click",()=>{w&&w.classList.remove("active")}));const $t=()=>{if(!localStorage.getItem("token"))throw new Error("Token not found");if(h.length>0){console.log(h),h.forEach(o=>{o.hotdog_id&&o.hotdog_id>=1e3&&(o.hotdog_id=null)}),_t(h,100);const t=document.querySelector(".cart-content");if(!t)return;h=[],k=[],t.innerHTML="",T()}},it=e=>{const t=e.target;if(t.parentElement){const o=t.getAttribute("data-hotdog-index");if(!o)return;const r=parseInt(o);document.querySelectorAll("[data-hotdog-index]").forEach(a=>{const s=a.getAttribute("data-hotdog-index");if(!s)return;const i=parseInt(s);i>r&&a.setAttribute("data-hotdog-index",(i-1).toString())}),t.parentElement.remove(),h.splice(r,1),console.log(h),T()}},ct=e=>{const t=e.target;t.setAttribute("data-quantity",t.value);const o=t.getAttribute("data-quantity");let r=parseInt(o||"0",10);const n=t.dataset.id;h.forEach(a=>{a.hotdog_id===parseInt(n||"0",10)&&(a.ordersHotdogsAmount=r)}),T()},dt=async e=>{const t=e.target,o=t.closest(".menu-item-container");if(t.closest(".total-box")){const n=Object.values(v).reduce((s,i)=>(s+=i.topping_price,s),0),a="Custom Hotdog";if(!n||!a)return;if(console.log("name",v[0].topping_name),n&&a){let s="";v.forEach((p,c)=>{c===v.length-1?s+=p.topping_name:s+=p.topping_name+", "});let i=1e3;k.length<1||(i=k[k.length-1]+1),k.push(i),Z(a,n.toFixed(2)+"€, ",s,i),T();const u=v.map(p=>p.topping_id);console.log("customIngredients",v,"topping_ids",u),h.push({hotdog_id:i,ordersHotdogsAmount:1,base_price:1,toppings:u})}}if(o){const n=o.querySelector(".menu-food-title"),a=o.querySelector(".menu-price"),s=o.querySelector(".menu-ingredients");if(!n||!a||!s)return;const i=n.id.split("-")[1],u=parseInt(i,10),c=(await m(l+"/hotdog/"+i))[0].hotdog_id,d=await m(l+"/hotdog/hotdogToppings/"+i);let g="";if(d.forEach((f,b)=>{b===d.length-1?g+=f.topping_name:g+=f.topping_name+", "}),n&&a&&u&&s){const f=n.textContent||"",b=a.textContent||"";h.push({hotdog_id:c,ordersHotdogsAmount:1}),Z(f,b,g,c),T()}}};document.addEventListener("click",e=>{const t=e.target;t&&t.classList.contains("add-to-cart-btn")&&dt(e)});const Z=(e,t,o,r)=>{const n=document.createElement("div");n.classList.add("cart-box");const a=document.querySelector(".cart-content");if(!a)return;const s=a.querySelectorAll(".cart-product-title");let i=0;console.log(i);for(let g=0;g<s.length;g++)if(console.log(s[g]),s[g].innerText==="Custom Hotdog")i++;else if(s[g].innerText===e)return;const u=h.length-1,p=`
